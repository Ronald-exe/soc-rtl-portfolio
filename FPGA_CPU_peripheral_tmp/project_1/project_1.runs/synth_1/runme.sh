...
HD_PWD='C:/Taller_digitales/lab4/Funcional_control_cpu/Nueva carpeta/Nueva carpeta/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_basys_cpu.tcl
