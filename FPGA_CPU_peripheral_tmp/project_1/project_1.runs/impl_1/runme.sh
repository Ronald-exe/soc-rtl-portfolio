...
HD_PWD='C:/Taller_digitales/lab4/Funcional_control_cpu/Nueva carpeta/Nueva carpeta/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys_cpu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_basys_cpu.tcl -notrace
